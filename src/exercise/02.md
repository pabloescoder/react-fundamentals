...
Elaborate on your learnings here in `src/exercise/02.md` <br /> <br /> Learned
how to work with Raw react APIs like React.createElement instead of using JSX to
manipulate the DOM. Also learned the difference between Imperative and
Declararive programming.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=02%3A%20Intro%20to%20raw%20React%20APIs&em=pabloescoder%40gmail.com).
