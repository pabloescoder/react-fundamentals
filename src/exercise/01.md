...
Elaborate on your learnings here in `src/exercise/01.md` <br /> I learnt and
revised how to manipulate the DOM using JS inorder to display/ modify HTML
elements and rendered "Hello World" on the screen by JS instead of doing that
using HTML.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=01%3A%20Basic%20JavaScript-rendered%20Hello%20World&em=pabloescoder%40gmail.com).
