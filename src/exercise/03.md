...
Elaborate on your learnings here in `src/exercise/03.md` <br /> <br /> Learned
how to use JSX inorder to render HTML elements on a webpage. Learned how I can
use the spread operator in JSX as well as how to use JS in JSX using {} curly
braces.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=03%3A%20Using%20JSX&em=pabloescoder%40gmail.com).
