...
Elaborate on your learnings here in `src/exercise/04.md`<br /><br />Learned how
to make custom components, using PropTypes for runtime prop validation and where
and when to use React fragments.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=04%3A%20Creating%20custom%20components&em=pabloescoder%40gmail.com).
